...
public class HiddenStringUtils {
    ...
    private static final String SEQUENCE_HEADER = "" + ChatColor.RESET + ChatColor.UNDERLINE + ChatColor.RESET+ " " + ChatColor.BOLD;
    private static final String SEQUENCE_FOOTER = "" + ChatColor.RESET + ChatColor.ITALIC + ChatColor.RESET + " " + ChatColor.BOLD;
